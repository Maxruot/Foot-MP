...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM yogurt_endulzado";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title> yogurt endulzado tabla </title>
...
if($resultado->num_rows>0){
    echo "<table>";
    echo "<tr><th></th><th>Nombre nutriente</th><th>valor</th><th></th><th></th></tr>";
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_yogurt_endulzado.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_yogurt_endulzado.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_yogurt_endulzado.php'"
