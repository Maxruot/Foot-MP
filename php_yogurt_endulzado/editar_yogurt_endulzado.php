...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM yogurt_endulzado WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_yogurt_endulzado.php" method="POST">
    <?php
